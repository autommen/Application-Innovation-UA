...
class TFTrainingArgumentsWithMPSSupport(TFTrainingArguments):
    @property
...
def main():
    ...
    parser = HfArgumentParser((ModelArguments, DataTrainingArguments, TFTrainingArgumentsWithMPSSupport))
